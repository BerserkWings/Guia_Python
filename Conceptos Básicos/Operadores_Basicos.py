...
- **Map**: Aplica una función específica a cada elemento de una lista, lo que resulta útil para transformar los datos contenidos.
"""
...
print("Esto es una suma: " + str(numero1 + numero2))

resultado_suma = numero1 + numero2
print("Este es el resultado de una suma: " + str(resultado_suma))
